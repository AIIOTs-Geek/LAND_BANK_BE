...
namespace Services.IService
{
    public interface ILandService
    {
        ...
        Task<APIResponse<List<LandByAssetIdVm>>> GetLandsByAssetIdForViewer(int assetId, string? searchText, int? cityId, int? districtId, int? userId, int? landUseId, int? businessPlanId, int? IsWlt, int pageno, int pagesize);
