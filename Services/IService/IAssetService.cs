...
namespace Services.IService
{
    ...
    {        
        ...
        Task<APIResponse<List<AssetVm>>> GetAssets(string? searchText, int? cityId, int? districtId, int? assetId, int pageNo=1, int pageSize=10);
        Task<APIResponse<List<StatusVm>>> GetLandUsesAsync(string statusType);
    }
}
